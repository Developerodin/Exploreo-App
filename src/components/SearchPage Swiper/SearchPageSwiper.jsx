...
const data = [
  ...
  const CompanyData = [
    { Img: img1, title: "#sports" },
    { Img: img2, title: "#bike" },
    { Img: img3, title: "#rides" },
    { Img: img4, title: "#mountain" },
    { Img: img1, title: "#bikelover" },
    { Img: img1, title: "#sports" },
    { Img: img2, title: "#bike" },
    { Img: img3, title: "#rides" },
    { Img: img4, title: "#mountain" },
...
export default SearchPageSwiper
